...
import com.place.search.presentation.external.model.CategoryGroupCode
...
data class LocalSearchRequest(
    ...
    val x: String? = null, // 중심 좌표의 X 혹은 경도(longitude) 값

    // 중심 좌표의 Y 혹은 위도(latitude) 값
    // 특정 지역을 중심으로 검색할 경우 radius와 함께 사용 가능
    val y: String? = null, // 중심 좌표의 Y 혹은 위도(latitude) 값
